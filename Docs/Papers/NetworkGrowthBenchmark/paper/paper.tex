\documentclass[urbansci,article,submit,pdftex,oneauthor]{Definitions/mdpi} 
...
% https://www.mdpi.com/journal/urbansci/instructions
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\authorcontributions{For research articles with several authors, a short paragraph specifying their individual contributions must be provided.}
